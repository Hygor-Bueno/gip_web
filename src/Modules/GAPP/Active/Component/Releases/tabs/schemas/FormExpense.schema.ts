...
export const formExpense = (
  ...
  { attributes: { className: 'my-2 col-6 col-md-4' }, item: { label: 'Estabelecimento',  mandatory: true, captureValue: { type: 'text',     name: 'local',         className: 'form-control', value: values.local         ?? '', onChange, required: true, placeholder: 'Nome do posto / fornecedor' } } },
