...
export const formVehicle = (
    ...
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'Placa', mandatory: true, captureValue: { type: 'text', name: 'license_plates', className: 'form-control', value: values.license_plates ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-6 col-md-4' }, item: { label: 'Ano', mandatory: true, captureValue: { type: 'number', name: 'year', className: 'form-control', value: values.year ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-6 col-md-4' }, item: { label: 'Modelo', mandatory: true, captureValue: { type: 'number', name: 'year_model', className: 'form-control', value: values.year_model ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-12 col-md-4' }, item: { label: 'Chassi', mandatory: true, captureValue: { type: 'text', name: 'chassi', className: 'form-control', value: values.chassi ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'Cor', mandatory: true, captureValue: { type: 'text', name: 'color', className: 'form-control', value: values.color ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'RENAVAM', mandatory: true, captureValue: { type: 'text', name: 'renavam', className: 'form-control', value: values.renavam ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'Potência', mandatory: true, captureValue: { type: 'number', step: '0.01', name: 'power', className: 'form-control', value: values.power ?? '', onChange, required: true } } },
    ...
    { attributes: { className: 'my-2 col-12 col-md-4' }, item: { label: 'Combustível', mandatory: true, captureValue: { type: 'select', name: 'fuel_type_id_fk', className: 'form-control', options: fuelTypeList, value: values.fuel_type_id_fk ?? '', onChange, required: true } } },
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'Blindagem', mandatory: true, captureValue: { type: 'select', name: 'shielding', className: 'form-control', options: [{ label: 'Sim', value: 1 }, { label: 'Não', value: 0 }], value: values.shielding ? '1' : '0', onChange, required: true } } },
