...
export const formActive = (
    ...
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'É um veículo?', captureValue: { type: 'select', name: 'is_vehicle', className: 'form-control', options: [{ label: 'Sim', value: '1' }, { label: 'Não', value: '0' }], value: '0', onChange } } },
];