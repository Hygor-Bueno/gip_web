import { maskCEP } from "../../../../../../Util/Utils";
...
export const formAddress = (
    ...
    { attributes: { className: 'my-2 col-6 col-md-3' }, item: { label: 'CEP', captureValue:{ type: 'text', name: "place_purchase.zip_code", className: "form-control", value: maskCEP(String(values.zip_code)) ?? '', onChange } } },
