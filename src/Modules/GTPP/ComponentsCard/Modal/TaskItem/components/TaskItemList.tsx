            ...
            {(taskItem.id && positionTaskStates[taskItem.id]) &&
              <div>
                <button onClick={async () => {
                  changePositionItem(false, taskItem.id || 0, taskDetails, setTaskDetails);
                ...
                <button onClick={async () => {
                  changePositionItem(true, taskItem.id || 0, taskDetails, setTaskDetails);
            ...
            <div className="container-fluid">
              ...
              <div className="row justify-content-between align-items-center">
                ...
                <div className="col-sm-6 d-flex justify-content-end gap-2">
                  {taskItem.note && (
                    <ButtonIcon title="Visualizar observação" color="primary" icon="circle-info" description="" onClick={() => closeObservation(taskItem)} />)}
                  <ButtonIcon title="Observação" color="primary" icon="pencil" description=""
                    onClick={() => {
                      setEditTask(taskItem);
                      setOnEditTask(true);
                    }}
                  ...
                  <ButtonIcon title="Remover" color="danger" icon="trash" description="" onClick={() => {
